...
#[[ 
	...
	macro( read_ACME_info _FN )
		...
		list( JOIN _VI "\n" _dbg )
		ACME_grep_list( _VI RELEASE		"^.*RELEASE[ \t]+\"(.*)\".*$" )
		ACME_grep_list( _VI CODENAME		"^.*CODENAME[ \t]+\"(.*)\".*$" )
		ACME_grep_list( _VI CHANGE_DATE	"^.*CHANGE_DATE[ \t]+\"(.*)\".*$" )
		ACME_grep_list( _VI CHANGE_YEAR	"^.*CHANGE_YEAR[ \t]+\"(.*)\".*$" )
		ACME_grep_list( _VI HOME_PAGE	"^.*HOME_PAGE[ \t]+\"(.*)\".*$" )
