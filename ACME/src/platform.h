...
#	define PLATFORM_VERSION "DOS/OS2 version. Compiled by Dirk Hoepfner"
#	include "_dos.h"
#endif

// Windows
#if defined( __Windows__ ) || defined( WIN32 ) || defined( _WIN32 ) || defined( __WIN32__ )        \
	|| defined( _WIN64 ) || defined( __MINGW32__ ) || defined( __MINGW64__ )
#	define PLATFORM_VERSION "Windows version - built with the Obsessed Maniacs' CMake Integration."
#	include "_dos.h"
#endif
